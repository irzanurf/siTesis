<div class="container-fluid">
    <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark mb-0">Berita Acara Seminar Proposal</h3>
    </div>
    <div class="row"><br>
    ...
    <div class="col-lg-8" style="float:none;margin:auto;">
        <!-- /.row -->
        <form role="form" method="post" action="<?= base_url('Admin/print_sempro');?>" enctype="multipart/form-data">

            <div class="form-group">
                <button name="button" value="1" type="submit" id="submit" class="btn btn-primary"><i
                        class="fa fa-download"></i> Berita acara untuk pengelola</button>

                <button name="button" value="2" type="submit" id="submit" class="btn btn-success"><i
                        class="fa fa-download"></i> Berita acara dan saran untuk mahasiswa</button>
            </div>
            ...
            <div class="form-group"><label>Keputusan jenis rekomendasi</label><label style="color:red; font-size:12px;">
                    (*Wajib diisi)</label>
                <select style="pointer-events: none;" class="form-control" name="app" id="app" required="">
                    <?php
                                        foreach ($app as $a) {
                                            ?>
                    <option value="<?php echo $a->ket; ?>"
                        <?php echo ($view->status==$a->app) ? "selected='selected'" : "" ?>><?php echo $a->app; ?>
                    </option>
                    <?php
                                        }
                                        ?>
            ...
            <p>Keterangan: <br> <b>ACC A</b> = Lulus dan berhak melanjutkan proposal tesis dan penelitian untuk
                menghasilkan tesis<br>
                <b>ACC B</b> = Lulus dan berhak melanjutkan proposal tesis dan penelitian setelah membuat pembetulan
                kecil<br>
                <b>ACC C</b> = Lulus dan berhak berhak melanjutkan proposal tesis dan penelitian setelah membuat
                perbaikan sebagaimana tertera dalam lampiran perbaikan yang tidak terpisah dari berita acara ini<br>
                <b>ACC D</b> = Tidak lulus, tetapi berhak untuk mengajukan seminar ulang setelah melakukan pembetulan,
                perbaikan, dan kajian atau penelitian pendahuluan ulang sebagaimana tertera dalam lampiran perbaikan
                yang tidak terpiah dari berita acara ini
            </p>
